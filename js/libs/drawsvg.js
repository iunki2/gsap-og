...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function y (e) {
    ...
    if (r && (r.width || r.height) || 'rect' !== h && 'circle' !== h && 'ellipse' !== h || (r = {
      ...
      'circle' !== h && 'ellipse' !== h || (n = r.width / 2 * f, a = r.height / 2 * d, t = Math.PI * (3 * (n + a) - Math.sqrt((3 * n + a) * (n + 3 * a))))
    }
    return t || 0
  }
  ...
  'use strict'
  var t = function () {return (_gsScope.GreenSockGlobals || _gsScope).DrawSVGPlugin}
